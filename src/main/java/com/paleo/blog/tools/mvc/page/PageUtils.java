package com.paleo.blog.tools.mvc.page;
...
public class PageUtils {
	...
	public final static String DEFAULT_PARAMNAME_PAGENUM = "pageNum";//当前页

	public final static String DEFAULT_PARAMNAME_PAGESIZE = "pageSize";//每页数量
